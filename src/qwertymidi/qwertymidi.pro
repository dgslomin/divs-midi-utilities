...
HEADERS += qwertymidi.h
SOURCES += qwertymidi.cpp ../../midiutil/midiutil-common.c ../../midiutil/midiutil-rtmidi.c ../../midiutil/midiutil-qt.cpp ../../3rdparty/rtmidi/RtMidi.cpp ../../3rdparty/rtmidi/rtmidi_c.cpp
